...
def main():
    ...
    for epoch in range(config.NUM_EPOCHS):
        train_fn(
            disc, gen, train_loader, opt_disc, opt_gen, L1_LOSS, BCE, g_scaler, d_scaler, label_smoothing=0.0
        )
        ...
        if config.SAVE_MODEL and epoch % 5 == 0:
            ...
            save_some_examples(gen, val_loader, epoch, folder="evaluation_transcgan_cityscape")
